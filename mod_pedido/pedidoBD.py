...
class PedidosProdutos():
    ...
    def selectProdutosByPedido(self):
        ...
        try:
            ...
            _sql = 'SELECT tp.descricao,tpp.id_pedido FROM tb_produtos tp INNER JOIN tb_pedido_produtos tpp ON tp.id_produto = tpp.id_produto GROUP BY tp.descricao HAVING tpp.id_pedido = %s'
